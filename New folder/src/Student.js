                ...
                return (
                    <div className="col-md-4 float-start">
                        <div className="card p-3 mb-3">
                            <div className="card" >
                                <img src={s.avatar} className="card-img-top" alt="..."/>
                                <div className="card-body" >
                                    <h5 className="card-title">Name :{s.name} </h5>
                                    <h5 className="card-title">Department :{s.department} </h5>
                                    <h5 className="card-title">Roll no :{s.roll_no} </h5>
                                    <h5 className="card-title">City :{s.city} </h5>
                                </div>
                            </div>  
                        </div>
                    </div>    
